...
CREATE TABLE IF NOT EXISTS svns_skill(id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL, player INT UNSIGNED NOT NULL UNIQUE, skill REAL NOT NULL,
  CONSTRAINT FOREIGN KEY(player) REFERENCES svns_players(id) ON DELETE CASCADE) ENGINE=InnoDB;
CREATE TABLE IF NOT EXISTS svns_rank(id INT UNSIGNED AUTO_INCREMENT PRIMARY KEY NOT NULL, player INT UNSIGNED NOT NULL UNIQUE, rank INT UNSIGNED NOT NULL,
  CONSTRAINT FOREIGN KEY(player) REFERENCES svns_players(id) ON DELETE CASCADE) ENGINE=InnoDB;